...
public class FxSubscriptionServiceApplication {
	...
	@Bean
	public ToolCallbackProvider fxSubscriptionTools(FxSubscriptionTool fxSubscriptionTool) {
		return MethodToolCallbackProvider.builder().toolObjects(fxSubscriptionTool).build();
	}
}
